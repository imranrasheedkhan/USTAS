...
public void addLeaveInfo(LeaveInfo leaveInfo,EntityManager em,UserTransaction ut)
{
	try
	{
...
public void updateLeaveInfo(LeaveInfo leaveInfo,EntityManager em, UserTransaction ut)
{
		try
		{
	       ut.begin();
